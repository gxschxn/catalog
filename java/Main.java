public class Main {
    public static void main(String[] args) {
        ...
        app.addToCart("Двигатель V6 - 350000 руб. (1) [Двигатель: V6]");
        app.addToCart("Литые диски - 80000 руб. (4) [17 inch, 5x114.3]", 4);
        ...
        app.addToCart("Двигатель V6 - 350000 руб. (1) [Двигатель: V6]", -5); // Отрицательное количество
        app.addToCart("Двигатель V6 - 350000 руб. (1) [Двигатель: V6]", 20); // Слишком большое количество
